...
import backgroundImage from '../background_home.jpg'
    ...
    JitsiInit(roomID, participants) {
        return new Promise((resolve, reject) => {
            ...
            function onConnectionSuccess() {
                ...
                room.on(JitsiMeetJS.events.conference.USER_LEFT, () => participantCallback(room));
                room.on(JitsiMeetJS.events.conference.TRACK_MUTE_CHANGED, (track) => {
                    // onTrackUpdate(track);
                    participantCallback(room)
                });
            ...
            <div>
                ...
                <Form.Group controlId="formBasicEmail">
                    ...
                    <Form.Control style={{
                        ...
                        "textAlign":"center",
                        "margin":"auto"
                    }} isInvalid={this.state.roomIDError}  name="roomname" type="text" placeholder="Enter id" onChange={this.onMeetChange} />
                    {
                ...
                {this.state.joined === false ? <Button variant="primary" type="submit" onClick={this.JitsiConnect} > 
                    Submit
                </Button> :
                ...
                <div className="canvas" id="canvas" style={{
                            margin:"10px",
                            "textAlign":"center",
                            marginRight:"10px",
                            marginBottom:"10px",
                ...
                {this.state.participants.map((participant, index)=>{
                    ...
                    return ( 
                        <Draggable isLocal={participant.isLocal} children={   
                            <>     
                        <div className="vidCont">
                            <video id={`${index}_video`} key={`${index}_video_track`} className="circle-vid" autoPlay={true} playsInline={true} style={{
                                position: 'relative',
                                objectFit:  'cover',
                            ...
                            <audio id={`${index}_audio`} key={`${index}_audio_track`} muted={participant.isLocal} autoPlay={true} playsInline={true} style={{
                                display: 'none'
                            }}/>
                        </div>
                        </>

...
! function(t, e) {
    ...
    function N(t, e) {
        var n;
        if (e.touches)
            for (var o = n = 0, r = e.touches; o < r.length; o++) {
                var a = r[o];
                a.pointerId = n++, N(t, a)
    ...
    function t(c, l) {
        ...
        if (1 !== c.nodeType) throw new Error("Panzoom requires an element with a nodeType of 1");
        if (t = (e = c).ownerDocument, e = e.parentNode, !(t && e && 9 === t.nodeType && 1 === e.nodeType && t.documentElement.contains(e))) throw new Error("Panzoom should be called on elements that have been attached to the DOM");
        var t;
        l = C(C({}, G), l);
        var e, p = (e = c, F.test(e.namespaceURI) && "svg" !== e.nodeName.toLowerCase()),
            n = c.parentNode;
        n.style.overflow = l.overflow, n.style.userSelect = "none", n.style.touchAction = l.touchAction, (l.canvas ? n : c).style.cursor = l.cursor, c.style.userSelect = "none", c.style.touchAction = l.touchAction, B(c, "transformOrigin", "string" == typeof l.origin ? l.origin : p ? "0 0" : "50% 50%");
        var o, r, a, i, d, s, u = 0,
            f = 0,
            m = 1,
            h = !1;
        ...
        function g(t, e, n) {
            ...
            return requestAnimationFrame(function() {
                var t;
                "boolean" == typeof e.animate && (e.animate ? (t = e, B(c, "transition", q("transform") + " " + t.duration + "ms " + t.easing)) : B(c, "transition", "none")), e.setTransform(c, o, e)
            }), v(t, o, e), v("panzoomchange", o, e), o
        }

        function y() {
            var t, e, n;
            l.contain && (e = (n = D(c)).parent.width - n.parent.border.left - n.parent.border.right, t = n.parent.height - n.parent.border.top - n.parent.border.bottom, e = e / (n.elem.width / m), n = t / (n.elem.height / m), "inside" === l.contain ? l.maxScale = Math.min(e, n) : "outside" === l.contain && (l.minScale = Math.max(e, n)))
        }
        ...
        function E(t, e, n) {
            ...
            if (r.force || !r.disableZoom) {
                ...
                var a = u,
                    e = f;
                r.focal && (a = ((o = r.focal).x / t - o.x / m + u * t) / t, e = (o.y / t - o.y / m + f * t) / t);
                e = w(a, e, t, {
                    relative: !1,
                    force: !0
                });
        ...
        function S(t, e) {
            ...
            return E(m * Math.exp((t ? 1 : -1) * e.step), e)
        }
        ...
        function M(t, e, n, o) {
            ...
            p || (l -= r.elem.width / m / 2, e -= r.elem.height / m / 2);
            i = {
                x: l / a * (a * t),
                y: e / i * (i * t)
            };
        ...
        function P(t) {
            ...
            }(t.target, l) && (N(O, t), h = !0, l.handleStartEvent(t), v("panzoomstart", {
                x: o = u,
                y: r = f,
                scale: m,
                isSVG: p,
                originalEvent: t
            }, l), t = L(O), a = t.clientX, i = t.clientY, d = m, s = I(O))
        }

        function z(t) {
            h && void 0 !== o && void 0 !== r && void 0 !== a && void 0 !== i && (N(O, t), t = L(O), 1 < O.length ? (0 === s && (s = I(O)), M(b((I(O) - s) * l.step / 80 + d).scale, t)) : x(o + (t.clientX - a) / m, r + (t.clientY - i) / m, {
                animate: !1
            }))
        }

        function A(t) {
            1 === O.length && v("panzoomend", {
                    x: u,
                    y: f,
                    scale: m,
                    isSVG: p,
                ...
                }(O, t), h && (h = !1, o = r = a = i = void 0)
        }
        var X = !1;

        function Y() {
            X || (X = !0, W("down", l.canvas ? n : c, P), W("move", document, z, {
                passive: !0
            }), W("up", document, A, {
                passive: !0
            }))
        ...
        return l.noBind || Y(), {
            bind: Y,
            destroy: function() {
                X = !1, Z("down", l.canvas ? n : c, P), Z("move", document, z), Z("up", document, A)
            },
            eventNames: V,
            getPan: function() {
                return {
            ...
            reset: function(t) {
                ...
                return m = b(e.startScale, e).scale, t = w(e.startX, e.startY, m, e), u = t.x, f = t.y, g("panzoomreset", e)
            },
            setOptions: function(t) {
                for (var e in void 0 === t && (t = {}), t) t.hasOwnProperty(e) && (l[e] = t[e]);
                t.hasOwnProperty("cursor") && (c.style.cursor = t.cursor), t.hasOwnProperty("overflow") && (n.style.overflow = t.overflow), t.hasOwnProperty("touchAction") && (n.style.touchAction = t.touchAction, c.style.touchAction = t.touchAction), (t.hasOwnProperty("minScale") || t.hasOwnProperty("maxScale") || t.hasOwnProperty("contain")) && y()
            },
            ...
            zoomWithWheel: function(t, e) {
                t.preventDefault();
                var n = C(C({}, l), e),
                    e = (0 === t.deltaY && t.deltaX ? t.deltaX : t.deltaY) < 0 ? 1 : -1;
                return M(b(m * Math.exp(e * n.step / 3), n).scale, t, n)
            }
        }
    }
